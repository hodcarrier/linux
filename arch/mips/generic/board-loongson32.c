...
#define pr_fmt(fmt) "loongson32: " fmt
...
static __init bool loongson32_detect(void)
{
	uint32_t rev;
...
static const struct mips_fdt_fixup loongson32_fdt_fixups[] __initconst = {
...
static __init const void *loongson32_fixup_fdt(const void *fdt,
...
static __init unsigned int loongson32_measure_hpt_freq(void)
{
...
extern char __dtb_ls1c300_eval_begin[];

MIPS_MACHINE(loongson32) = {
	.fdt = __dtb_ls1c300_eval_begin,
	.detect = loongson32_detect,
	.fixup_fdt = loongson32_fixup_fdt,
	.measure_hpt_freq = loongson32_measure_hpt_freq,
};
